      ...
      {isOpen && (
        <div className="absolute top-[calc(100%+0.5rem)] left-0 right-0 bg-white border border-[var(--pine)]/5 rounded-[32px] p-6 shadow-2xl md:hidden animate-in fade-in slide-in-from-top-4 duration-300">
          <div className="flex flex-col gap-5">
            ...
            <div className="pt-2">
              <p className="text-[10px] uppercase tracking-widest font-bold text-[var(--pine)]/40 mb-4">Quick Connect</p>
              <div className="grid grid-cols-2 gap-3">
                <a href="tel:+9194191" className="text-sm font-medium p-3 bg-[var(--cream)] rounded-xl text-center">Call Us</a>
                <a href="mailto:pinecode47@gmail.com" className="text-sm font-medium p-3 bg-[var(--cream)] rounded-xl text-center">Email</a>
              </div>
            </div>
          </div>
        </div>
